        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 md:py-24 lg:grid-cols-[1.1fr_.9fr] lg:items-center lg:px-8">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Link href="/about" className="inline-flex h-12 items-center justify-center rounded-full border border-slate-300 bg-white px-6 text-sm font-bold text-slate-800 transition hover:bg-slate-50">
                Our story
              </Link>
            </div>
          ...
          <div className="relative min-h-[420px] rounded-[2rem] bg-slate-950 p-6 text-white shadow-2xl shadow-slate-300/60 sm:p-8">
            ...
            <div className="relative flex h-full flex-col justify-between">
              ...
              <div className="my-14 grid gap-3">
                <Link href="/product" className="group flex items-center justify-between rounded-2xl bg-white p-5 text-slate-950 transition hover:-translate-y-1">
